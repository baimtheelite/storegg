...
export default function TransactionDetailContent(props: TransactionDetailContentProps) {
  ...
  const tax = data.historyVoucherTopup.price * 0.1;
  const total = data.historyVoucherTopup.price + tax;
          ...
          <div className="main-content main-content-card overflow-auto">
            <section className="checkout mx-auto">
              <div className="d-flex flex-row  align-items-center justify-content-between mb-30">
                ...
                <div>
                  <p className={`${statusClass}`} style={{ textTransform: 'capitalize' }}>
                    {data.status}
                  </p>
                </div>
              </div>
              ...
              <div className="purchase pt-30">
                ...
                <Row label="Your Game ID" value={data._id} />
